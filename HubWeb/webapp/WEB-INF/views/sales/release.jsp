...
<h3 id="subHeader-name">출고처리서</h3>
	...
	<input class="btn btn-primary btn-sm" type="button" id="orderBookApply" value="출고지시서적용">
</div>
</nav>

<div id="jspcontent">
  <!-- 모든 검색조건이 포함되는 form -->
	<form:form id="searchForm" action="${cPath}/sales/ReleaseProcessingRetrieve.do"> 
	 <fieldset>
...
<div id="orderbookApplyForPI-modal" class="modal-overlay modal">
	<div class="modal-applyLg">
		<div class="title">출고지시서 적용</div>
		<div class="close-area">X</div>
		<div class="content">
			<form:form id="obApplySearchForm" action="${cPath }/sales/piSalesCloseApply.do" method="post">
		 	 	...
		 	 	<input type="text" name="orbNum" id="orbNumByPI" placeholder="출고지시서번호" />
 ...
 <script src="${cPath}/resources/js/sales/releaseForPI.js"></script>
 <script src="${cPath}/resources/js/sales/releaseprocessing.js"></script>
