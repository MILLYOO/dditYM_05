...
public class MemberUpdateController {
	...
	@RequestMapping // @AuthenticationPrincipal => MemberVOWrapper
					// @AuthenticationPrincipal(expression="authMember") => MemberVO
	public String doGet(@AuthenticationPrincipal(expression="authMember") MemberVO authMember, Model model) {
