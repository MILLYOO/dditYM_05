...
public class MemberRetrieveController {
	...
	public String memberVIew(@RequestParam(value="who", required=true) String memId, Model model) {
	...
	@ResponseBody
	public PagingVO<MemberVO> form(@RequestHeader("accept") String accept,
			@RequestParam(value = "page", required = false, defaultValue = "1") int currentPage,
			@ModelAttribute("searchVO") SearchVO searchVO, Model model) throws ServletException, IOException {
