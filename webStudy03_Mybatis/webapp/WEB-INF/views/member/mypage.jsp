...
<body>
	<table border="1">
		<thead>
			...
			<tr>
				<td colspan="2">
					<input type="button" value="회원정보수정" onclick="location.href='<%=request.getContextPath()%>/member/memberUpdate.do';"/> 
