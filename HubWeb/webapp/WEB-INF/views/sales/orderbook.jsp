...
<h3 id="subHeader-name">수주서</h3>
	...
	<input class="btn btn-primary btn-sm" type="button" id="orderBookApply" value="견적서적용">
</div>
</nav>

<div id="jspcontent">
 <!-- 모든 검색조건이 포함되는 form -->
	<form:form id="searchForm" action="${cPath}/sales/OrderbookRetrieve.do"> 
	 <fieldset>
...
<div id="orderbookApplyForPI-modal" class="modal-overlay modal">
	<div class="modal-applyLg">
		...
		<div class="content">
			<form:form id="obApplySearchForm" action="${cPath }/produce/piOrderBookApply.do" method="post">
		 	 	...
		 	 	<input type="text" name="orbNum" id="orbNumByPI" placeholder="견적서번호" />
 ...
 <script src="${cPath}/resources/js/sales/OrbForPI.js"></script>
 <script src="${cPath}/resources/js/sales/orderbook.js"></script>
