...
import kr.or.ddit.prod.service.ProdServiceImplTest;
...
public class ReflectionUtilsTest {
	...
	public void testGetMethodsWithAnnotationAtClass() throws InstantiationException, IllegalAccessException {
		Class targetClz = ProdServiceImplTest.class;
...
//	@Test
	public void testGetMethodsAtClass() {
		Class targetClz = ProdServiceImplTest.class;
		List<Method> methods = ReflectionUtils.getMethodsAtClass(targetClz, String.class, HttpServletRequest.class, HttpServletResponse.class); // 파라미터의 순서는 바뀔수 없다 아규먼트 위반
		methods.forEach((mtd)->{
			log.info("method : {}", mtd);
		});
	}
