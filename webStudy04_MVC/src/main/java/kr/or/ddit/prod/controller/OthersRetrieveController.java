...
@Controller
public class OthersRetrieveController extends HttpServlet {
	private OthersDAO dao = new OthersDAOImpl();
	
	@RequestMapping("/others/getBuyerList.do")
	public String retriveBuyerList(@RequestParam(value="lprodGu", required=false) String lprodGu,/* HttpServletRequest req,*/ HttpServletResponse resp) throws IOException, ServletException {
