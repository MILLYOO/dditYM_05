...
<pre>
	...
	3. (*****). 웹리소스 확보
		<%
			String srcURL = "/resources/images/sponzbob.jpg";
			String srcFileSystemPath = application.getRealPath(srcURL);
			File srcFile = new File(srcFileSystemPath);
			String destFolderURL = "/09"; // 논리적인 경로
			String destFolderFileSystemPath = application.getRealPath(destFolderURL); // 물리적인 경로
