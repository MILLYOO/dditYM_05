...
@Controller
public class EmployeeManageDeleteController {
	@Inject
	private EmployeeManageService service;
	@Inject
	private WebApplicationContext context;
	
	@PostMapping(value="/info1/employeeDelete.do", produces=MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseBody
	public Map<String, Object> employeeManageDelete(
		...
		if(!valid.checkError()) {
			valid.setResultMap(service.deleteEmployee(employee));
		}
